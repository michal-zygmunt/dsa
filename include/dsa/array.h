...
namespace dsa
{
     ...
     * @param[in] array1 input container
     * @param[in] array2 input container
     * @retval true if the content of \p array1 is lexicographically
     *         less than the content of \p array2
     ...
     * @param[in] array2 input container
     * @retval true if the content of \p array1 is lexicographically
     *         greater than the content of \p array2
     * @retval false otherwise
     */
    template<typename T, std::size_t N>
    auto operator>(const Array<T, N>& array1, const Array<T, N>& array2) -> bool
    {
        return operator<(array2, array1);
    }
     ...
     * @param[in] array2 input container
     * @retval true if the content of \p array1 is lexicographically
     *         less or equal than the content of \p array2
     * @retval false otherwise
     */
    template<typename T, std::size_t N>
    auto operator<=(const Array<T, N>& array1, const Array<T, N>& array2) -> bool
     ...
     * @param[in] array2 input container
     * @retval true if the content of \p array1 is lexicographically
     *         greater or equal than the content of \p array2
     * @retval false otherwise
     */
    template<typename T, std::size_t N>
    auto operator>=(const Array<T, N>& array1, const Array<T, N>& array2) -> bool
