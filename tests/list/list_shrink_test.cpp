...
int main() // NOLINT(modernize-use-trailing-return-type)
{
    ...
    try
    {
        ...
        auto cnt10 = list10.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto cnt11 = list11.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto cnt12 = list12.remove_if([](int val) -> bool { return val % 2 == 0; });
        ...
        auto cnt13 = list13.remove_if([](int val) -> bool { return val <= 5; });
        ...
        auto cnt19 = dsa::erase_if(list19, [](int val) -> bool { return val == 0; });
        ...
        auto cnt20 = dsa::erase_if(list20, [](int val) -> bool { return val == 0; });
        ...
        auto cnt21 = dsa::erase_if(list21, [](int val) -> bool { return val % 2 == 0; });
        ...
        auto cnt22a = dsa::erase_if(list22a, [](int val) -> bool { return val == 5; });
        ...
        auto cnt22b = dsa::erase_if(list22b, [](int val) -> bool { return val != 5; });
        ...
        auto cnt22c = dsa::erase_if(list22c, [](int val) -> bool { return val < 5; });
        ...
        auto cnt22d = dsa::erase_if(list22d, [](int val) -> bool { return val > 5; });
        ...
        auto cnt22e = dsa::erase_if(list22e, [](int val) -> bool { return val <= 5; });
        ...
        auto cnt22f = dsa::erase_if(list22f, [](int val) -> bool { return val >= 5; });
        ...
        auto cnt22g = dsa::erase_if(list22g, [](int val) -> bool { return val < (-5); });
        ...
        auto cnt22h = dsa::erase_if(list22h, [](int val) -> bool { return val > (-5); });
        ...
        auto cnt22i = dsa::erase_if(list22i, [](int val) -> bool { return val <= (-5); });
        ...
        auto cnt22j = dsa::erase_if(list22j, [](int val) -> bool { return val >= (-5); });
        ...
        auto cnt22k = dsa::erase_if(list22k, [](int val) -> bool { return val < 100; });
        ...
        auto cnt22l = dsa::erase_if(list22l, [](int val) -> bool { return val > 100; });
        ...
        auto cnt22m = dsa::erase_if(list22m, [](int val) -> bool { return val <= 100; });
        ...
        auto cnt22n = dsa::erase_if(list22n, [](int val) -> bool { return val >= 100; });
        ...
        auto cnt23a = list23a.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto cnt23b = list23b.remove_if([](int val) -> bool { return val != 0; });
        ...
        auto cnt23c = list23c.remove_if([](int val) -> bool { return val < 0; });
        ...
        auto cnt23d = list23d.remove_if([](int val) -> bool { return val > 0; });
        ...
        auto cnt23e = list23e.remove_if([](int val) -> bool { return val <= 0; });
        ...
        auto cnt23f = list23f.remove_if([](int val) -> bool { return val >= 0; });
        ...
        auto std_cnt10 = std_list10.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto std_cnt11 = std_list11.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto std_cnt12 = std_list12.remove_if([](int val) -> bool { return val % 2 == 0; });
        ...
        auto std_cnt13 = std_list13.remove_if([](int val) -> bool { return val <= 5; });
        ...
        // NOLINTNEXTLINE(misc-include-cleaner,-warnings-as-errors)
        auto std_cnt19 = std::erase_if(std_list19, [](int val) -> bool { return val == 0; });
        ...
        // NOLINTNEXTLINE(misc-include-cleaner,-warnings-as-errors)
        auto std_cnt20 = std::erase_if(std_list20, [](int val) -> bool { return val == 0; });
        ...
        // NOLINTNEXTLINE(misc-include-cleaner,-warnings-as-errors)
        auto std_cnt21 = std::erase_if(std_list21, [](int val) -> bool { return val % 2 == 0; });
        ...
        // NOLINTNEXTLINE(misc-include-cleaner,-warnings-as-errors)
        auto std_cnt22e = std::erase_if(std_list22e, [](int val) -> bool { return val <= 5; });
