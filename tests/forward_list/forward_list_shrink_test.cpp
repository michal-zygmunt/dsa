...
int main() // NOLINT(modernize-use-trailing-return-type)
{
    ...
    try
    {
        ...
        auto cnt7 = list7.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto cnt8 = list8.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto cnt9 = list9.remove_if([](int val) -> bool { return val % 2 == 0; });
        ...
        auto cnt10 = list10.remove_if([](int val) -> bool { return val <= 5; });
        ...
        auto cnt16 = dsa::erase_if(list16, [](int val) -> bool { return val == 0; });
        ...
        auto cnt17 = dsa::erase_if(list17, [](int val) -> bool { return val == 0; });
        ...
        auto cnt18 = dsa::erase_if(list18, [](int val) -> bool { return val % 2 == 0; });
        ...
        auto cnt20a = dsa::erase_if(list20a, [](int val) -> bool { return val == 5; });
        ...
        auto cnt20b = dsa::erase_if(list20b, [](int val) -> bool { return val != 5; });
        ...
        auto cnt20c = dsa::erase_if(list20c, [](int val) -> bool { return val < 5; });
        ...
        auto cnt20d = dsa::erase_if(list20d, [](int val) -> bool { return val > 5; });
        ...
        auto cnt20e = dsa::erase_if(list20e, [](int val) -> bool { return val <= 5; });
        ...
        auto cnt20f = dsa::erase_if(list20f, [](int val) -> bool { return val >= 5; });
        ...
        auto cnt20g = dsa::erase_if(list20g, [](int val) -> bool { return val < (-5); });
        ...
        auto cnt20h = dsa::erase_if(list20h, [](int val) -> bool { return val > (-5); });
        ...
        auto cnt20i = dsa::erase_if(list20i, [](int val) -> bool { return val <= (-5); });
        ...
        auto cnt20j = dsa::erase_if(list20j, [](int val) -> bool { return val >= (-5); });
        ...
        auto cnt20k = dsa::erase_if(list20k, [](int val) -> bool { return val < 100; });
        ...
        auto cnt20l = dsa::erase_if(list20l, [](int val) -> bool { return val > 100; });
        ...
        auto cnt20m = dsa::erase_if(list20m, [](int val) -> bool { return val <= 100; });
        ...
        auto cnt20n = dsa::erase_if(list20n, [](int val) -> bool { return val >= 100; });
        ...
        auto cnt21a = list21a.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto cnt21b = list21b.remove_if([](int val) -> bool { return val != 0; });
        ...
        auto cnt21c = list21c.remove_if([](int val) -> bool { return val < 0; });
        ...
        auto cnt21d = list21d.remove_if([](int val) -> bool { return val > 0; });
        ...
        auto cnt21e = list21e.remove_if([](int val) -> bool { return val <= 0; });
        ...
        auto cnt21f = list21f.remove_if([](int val) -> bool { return val >= 0; });
        ...
        auto std_cnt7 = std_list7.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto std_cnt8 = std_list8.remove_if([](int val) -> bool { return val == 0; });
        ...
        auto std_cnt9 = std_list9.remove_if([](int val) -> bool { return val % 2 == 0; });
        ...
        auto std_cnt10 = std_list10.remove_if([](int val) -> bool { return val <= 5; });
        ...
        // NOLINTNEXTLINE(misc-include-cleaner,-warnings-as-errors)
        auto std_cnt16 = std::erase_if(std_list16, [](int val) -> bool { return val == 0; });
        ...
        // NOLINTNEXTLINE(misc-include-cleaner,-warnings-as-errors)
        auto std_cnt17 = std::erase_if(std_list17, [](int val) -> bool { return val == 0; });
        ...
        // NOLINTNEXTLINE(misc-include-cleaner,-warnings-as-errors)
        auto std_cnt18 = std::erase_if(std_list18, [](int val) -> bool { return val % 2 == 0; });
        ...
        // NOLINTNEXTLINE(misc-include-cleaner,-warnings-as-errors)
        auto std_cnt20a = std::erase_if(std_list20a, [](int val) -> bool { return val == 5; });
